...
### 4. Mobile-First Responsive UX Refinements
...
### 5. Build-Time Database Connection Crash Fix
...
### 6. Isolated Environment Variable Profiles
...
### 7. Logo Branding on Login/Auth Page
...
### 8. Direct Member Registration inside Linkage Modal
...
### 9. Family Tree User Avatar API Route Fix
...
### 10. Unified Family Tree Profile Images & Inline Link Actions
...
### 11. Smart Marital Status Defaults & Locking
...
### 12. Google Pay Donations & Support Board
