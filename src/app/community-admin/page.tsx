...
export default function CommunityAdminPage() {
  ...
  const [approvalPassword, setApprovalPassword] = useState("Community123");

  const handleOpenApproveModal = (member: Member) => {
    setApprovalModalMember(member);
    setApprovalPassword("Community123");
  };
          ...
          <div className="bg-white w-full max-w-md rounded-3xl p-5 shadow-2xl border border-slate-100 flex flex-col space-y-4 select-none animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. Community123"
                className="w-full px-3.5 py-2.5 bg-slate-50 focus:bg-white rounded-xl border border-slate-200 text-xs font-mono font-bold text-slate-800 outline-hidden focus:border-emerald-500"
              />
              <p className="text-[10px] text-slate-400 font-medium leading-relaxed">
                Provide this initial password to the member. They can log in with their mobile number and change it later.
              </p>
            </div>
